...
.alert-success { background: #E8F5E9; border-left: 4px solid #1E7E34; color: #1E7E34; }
...
.badge-active    { background: #1E7E34; color: #ffffff; }
.badge-draft     { background: #e0ddd8; color: #8BA7D4; }
.badge-coming    { background: #E7B1C3; color: #252535; }
.badge-published { background: #1E7E34; color: #ffffff; }
.badge-warning   { background: #A33359; color: #ffffff; }
.no-thumb {
    display: inline-block;
    background: #CE6487;
    color: #252535;
...
/* === CALLOUT === */
.callout { padding: 14px 16px; background: #F9ECF0; border-left: 4px solid #CE6487; border-radius: 6px; margin-bottom: 24px; font-size: 13px; line-height: 1.6; }
...
.bar-fill.nester   { background: #C44570; }
.bar-fill.busyer   { background: #74253F; }
...
function editProduct(data) {
    ...
    var viewBar = document.getElementById('product-view-bar');
    var viewUrl = document.getElementById('product-view-url');
    var viewLink = document.getElementById('product-view-link');
    if (viewBar && data.view_url) {
        viewBar.style.display = 'flex';
        viewUrl.textContent = data.view_url;
        viewLink.href = data.view_url;
    } else if (viewBar) {
        viewBar.style.display = 'none';
    }

    var thumbBar = document.getElementById('product-thumb-bar');
    var thumbImg = document.getElementById('product-thumb-preview');
    if (thumbBar) {
        if (data.image_path) {
            thumbBar.style.display = 'block';
            thumbImg.src = data.image_path;
        } else {
