...
<section class="section">
    <div class="container">
        ...
        <nav class="filter-nav">
            ...
            <button class="filter-tab" onclick="filterShop('free')">Free Tools</button>
        ...
        <div class="product-grid" id="shopGrid">
            ...
            <?php else: ?>
                ...
                ?>
                <div class="product-card fade-in" data-category="<?= esc($product['category']) ?>" data-free="<?= $isFree ? 'yes' : 'no' ?>">
                    <?php if ($isFree): ?>
...
function filterShop(category) {
    ...
    cards.forEach(function(card) {
        ...
        var isFree = card.getAttribute('data-free');
        if (category === 'all') { card.style.display = 'flex'; }
        else if (category === 'free') { card.style.display = (isFree === 'yes') ? 'flex' : 'none'; }
        else { card.style.display = (cardCat === category) ? 'flex' : 'none'; }
    });
}
</script>
