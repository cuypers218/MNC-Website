...
<section class="section">
    <div class="container text-center" style="padding: 4rem 0;">
        <h1 style="font-size: 3rem; color: #C44570; margin-bottom: 0.5rem;">404</h1>
        <p style="font-family: 'Montserrat', sans-serif; font-weight: 800; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.05em; color: #8BA7D4; margin-bottom: 2rem;">This page doesn't exist</p>
