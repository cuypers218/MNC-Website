...
<section class="section-cream">
    <div class="container-narrow text-center" style="padding-bottom: 0;">
        <p style="font-family: 'DM Sans', sans-serif; font-weight: 800; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 1px; color: #7F4928; margin-bottom: 1.5rem;">Not sure where you fit? Start here.</p>
        <h1 style="font-size: 1.6rem; color: #2B1F18; margin-bottom: 1.5rem;">What Kind of Empty Nester Are You?</h1>
    </div>
