...
<section class="section">
    <div class="container">
        ...
        <p class="text-center fade-in-delay-1" style="color: var(--warm-gray); font-size: 0.95rem; margin-bottom: 2rem;">Monthly updates from where I am right now — not where I've been.</p>
        ...
        <div class="text-center" style="padding: 3rem;">
            <p style="font-weight: 800; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.1em; color: var(--warm-gray); margin-bottom: 0.5rem;">MY NEST CHAPTER</p>
            <p style="color: var(--warm-gray); font-size: 0.95rem;">First posts are on the way. Check back soon.</p>
        </div>
        <?php endif; ?>
